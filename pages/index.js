...
const Home = () => {
  ...
  const octokit = new Octokit({
    auth: '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'
  })
  ...
  return (
    <div  className=''>
      ...
      {ready ? <div id='error'> <div className=' px-[4vh]  py-[5vh] h-[40vh] flex flex-col md:flex-row  md:space-x-[16vh]' >
